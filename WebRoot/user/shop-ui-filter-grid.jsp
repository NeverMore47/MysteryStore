                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="shop-ui-inner.jsp">Product Page</a></li>
                                <li class="active"><a href="shop-ui-filter-grid.jsp">Filter Grid Page</a></li>
    ...
    <div class="content container">
        <div class="row">
                                ...
                                <c:forEach items="${listBrands}" var="brand">
                                	<li>
                                        <label class="checkbox">
                                            <input type="checkbox" name="cateID" class="brandBox" value="${brand[0]}"/>
                                            <i></i>
                                            ${brand[0]}
                                            <small><a href="#">(${brand[1]})</a></small>
                                        </label>
                                    </li>
                                </c:forEach>
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <c:forEach items="${listCategories}" var="cate">
	                                <li>
	                                        <label class="checkbox">
	                                            <input type="checkbox" name="checkbox" class="boxCate" value="${cate[0]}"/>
	                                            <i></i>
	                                            ${cate[1]}
	                                        </label>
	                                    </li>
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-sm-8">
                        <ul class="list-inline clear-both">
                            <li class="grid-list-icons">
                                <a href="shop-ui-filter-list.jsp"><i class="fa fa-th-list"></i></a>
                                <a href="shop-ui-filter-grid.jsp"><i class="fa fa-th"></i></a>
                            </li>
                ...
                <!-- 第一行 -->
                    <div class="row illustration-v2 margin-bottom-30" id="listPro">
                        <div class="col-md-4"  v-for="item in result">
                            <div class="product-img product-img-brd">
                                <a href="/MysteryStore1.0/user/product_queryOne.action?"><img class="full-width img-responsive" src="assets/img/blog/16.jpg" alt=""></a>
                            ...
                            <div class="product-description product-description-brd margin-bottom-30">
                                <div class="overflow-h margin-bottom-5">
                                    <div class="pull-left" >
                                        <h4 class="title-price"><a href="shop-ui-inner.jsp">{{item.proName}}</a></h4>
                                        <span class="gender text-uppercase">{{item.proGender}}</span>
                                        <span class="gender">Suits - Blazers</span>
                                    </div>    
                                    <div class="product-price">
                                        <span class="title-price">¥{{item.proPrice * (item.proDiscount / 10)}}</span>
                                        <span class="title-price line-through">¥{{item.proPrice}}</span>
                                    </div>
                                </div>    
                    ...
                    <div id="listPro"><div v-for="item in result">{{item.proName}}</div></div> -->
                    		...
                    		methods: {
                             	...
                             	boxs.change(function() {
                            		...
                            		boxs.each(function() {
                             		...
                             		boxCates.each(function() {
                             			if(this.checked) {
                             				proCate +=  $(this).val()  + ",";
                             			}
                             		});
									$.ajax({
										url:"/MysteryStore1.0/user/filterGrid_queryProList.action",
										data:{proBrand:proBrand,proCate:proCate},
										dataType:"json",
                           	...
                           	boxCates.change(function() {
                             	...
                             	/* $(".boxCate").change(function() {
                             		debugger;
                             		var proCate = "";
                             		$(".boxCate").each(function() {
                             			if(this.checkd) {
                             				proCate += "'" + $(this).val + "',";
                             			}
                             		});
