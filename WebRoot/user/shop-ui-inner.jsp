                        ...
                        <li>
                            ...
                            <ul class="list-unstyled badge-open mCustomScrollbar" data-mcs-theme="minimal-dark">
                                ...
                                <li class="subtotal">
                                    ...
                                    <div class="row">    
                                        <div class="col-xs-6">
                                            <a href="shop-ui-inner.jsp" class="btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block">View Cart</a>
                                        </div>
                                        <div class="col-xs-6">
                                            <a href="shop-ui-add-to-cart.jsp" class="btn-u btn-u-sea-shop btn-block">Checkout</a>
                                        </div>
                                    </div>        
                                </li>    
                            </ul>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="index.jsp">Shop UI</a></li>
                                <li class="active"><a href="shop-ui-inner.jsp">Product Page</a></li>
                                <li><a href="shop-ui-filter-grid.jsp">Filter Grid Page</a></li>
                        ...
                        <!-- Main Demo -->
                        <li><a href="../index.jsp">Main Demo</a></li>
                        <!-- Main Demo -->
                    </ul>
                    <!-- End Nav Menu -->
                </div>
                ...
                <div class="col-md-6 md-margin-bottom-50">
                    <div class="ms-showcase2-template">
                        ...
                        <div class="master-slider ms-skin-default" id="masterslider">
                            <div class="ms-slide">
                                <img class="ms-brd" src="assets/img/blank.gif" data-src="<%=basePath %>${pro.proImgSrc}" alt="lorem ipsum dolor sit">
                                <img class="ms-thumb" src="<%=basePath %>${pro.proImgSrc}" alt="thumb">
                            </div>
                            <div class="ms-slide">
                                <img src="assets/img/blank.gif" data-src="<%=basePath %>${pro.proImgSrc}" alt="lorem ipsum dolor sit">
                                <img class="ms-thumb" src="<%=basePath %>${pro.proImgSrc}" alt="thumb">
                            </div>
                            <div class="ms-slide">
                                <img src="assets/img/blank.gif" data-src="<%=basePath %>${pro.proImgSrc}" alt="lorem ipsum dolor sit">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="list-inline product-ratings margin-bottom-30">
                        <c:forEach begin="1" end="5" varStatus="status">
							<c:if test="${status.index <= pro.review.reRating }">
                            ...
                            <span><a href="#reviews">Review</a>(${reviewNum})</span>
                        </li>
                    </ul><!--/end shop product ratings-->

                    <p>${pro.proDesc}</p><br>
					<input type="hidden" value="${pro.proId}" id="proId">
					
                    <ul class="list-inline shop-product-prices margin-bottom-30">
                        <li class="shop-red">¥${currentPrice}</li>
                        <li class="line-through">¥${pro.proPrice}</li>
                    ...
                    <ul class="list-inline product-size margin-bottom-30">
                    	<c:if test="${pro.category.cateId == 1 }">
	                        <li>
                    	...
                    	<c:if test="${pro.category.cateId == 2 }">
                    		<li>
	                            <input type="radio" id="size-1" name="size">
	                            <label for="size-1">38</label>
	                        </li>
	                        <li>    
	                            <input type="radio" id="size-2" name="size">
	                            <label for="size-2">39</label>
	                        </li>    
	                        <li>    
	                            <input type="radio" id="size-3" name="size" checked>
	                            <label for="size-3">40</label>
	                        </li>    
	                        <li>    
	                            <input type="radio" id="size-4" name="size">
	                            <label for="size-4">41</label>
	                        </li> 
	                        <li>    
	                            <input type="radio" id="size-5" name="size">
	                            <label for="size-4">42</label>
	                        </li> 
                    	</c:if>
                    </ul><!--/end product size-->
                    ...
                    <div class="margin-bottom-40">
                        ...
                        <button type="button" class="btn-u btn-u-sea-shop btn-u-lg" id="addToCart">Add to Cart</button>
                    </div><!--/end product quantity-->    

                    <ul class="list-inline add-to-wishlist add-to-wishlist-brd">
                        <li class="wishlist-in">
                            <i class="fa fa-heart"></i>
                            <a href="javascript:void(0)" id="addToWish">Add to Wishlist</a>
                        </li>
                    </ul>    
                    <p class="wishlist-category"><strong>Categories:</strong> <a href="#">${pro.category.cateName}</a> <a href="#">${pro.type.typeName}</a></p>
                </div>
            </div><!--/end row-->
        </div>    
    </div>
    ...
    <div class="content-md container">
        ...
        <div class="tab-v5">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a href="#reviews" role="tab" data-toggle="tab">Reviews (${reviewNum})</a></li>
            </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list-unstyled specifies-list">
                                        <li><i class="fa fa-caret-right"></i>Brand Name: <span>${pro.proBrand}</span></li>
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-unstyled specifies-list">
                                        ...
                                        <li><i class="fa fa-caret-right"></i>Item Type: <span>${pro.type.typeName}</span></li>
                                        ...
                                        <li><i class="fa fa-caret-right"></i>Gender: <span>${pro.proGender}</span></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 md-margin-bottom-40">
                        <a href="index.jsp"><img class="footer-logo" src="assets/img/logo-2.png" alt=""></a>
