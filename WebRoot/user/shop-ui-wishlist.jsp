...
<head>
    <title>Wish List | Unify - Responsive Website Template</title>
        ...
        <div class="container">
            <form class="shopping-cart" action="#">
                <div>
                    ...
                    <div style="float:right;background-color:#18ba9b;width:100px;height:30px;line-height:30px;text-align:center">
						<a href="#" style="text-decoration:none"><font color="white">Add to Cart</font></a>
					</div>
