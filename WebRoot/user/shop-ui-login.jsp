        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 md-margin-bottom-50">
                    <h2 class="welcome-title">Welcome to MysteryStore</h2>
                ...
                <div class="col-md-5">
                    <form id="sky-form1" class="log-reg-block sky-form" action="/MysteryStore1.0/customer/login_testLogin.action" method="post">
                        ...
                        <section>
                            <label class="input login-input">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Nickname" name="cust.custName" class="form-control">
                                </div>
                            </label>
                        </section>        
                        <section>
                            <label class="input login-input no-border-top">
                                <div class="input-group">
                                    ...
                                    <input type="password" placeholder="Password" name="cust.custPwd" class="form-control">
                                </div>    
                            </label>
                        </section>
                    ...
                    <p class="text-center">Don't have account yet? Learn more and <a href="shop-ui-register.jsp">Sign Up</a></p>
                </div>
            </div><!--/end row-->
        </div><!--/end container-->
    </div>
