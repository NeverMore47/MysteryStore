                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="list-inline right-topbar pull-right">
                            ...
                            <li><a href="shop-ui-login.jsp">Login</a> | <a href="shop-ui-register.jsp">Register</a></li>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="shop-ui-filter-list.jsp">Filter List Page</a></li>
            ...
            <div class="col-md-9">
                ...
                <div class="filter-results">
                    <div class="list-product-description product-description-brd margin-bottom-30">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.jsp"><img class="img-responsive sm-margin-bottom-20" src="assets/img/blog/16.jpg" alt=""></a>
                            </div> 
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
                                        <li><h4 class="title-price"><a href="shop-ui-inner.jsp">Double-breasted</a></h4></li>
                    ...
                    <div class="list-product-description product-description-brd margin-bottom-30">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.jsp"><img class="img-responsive sm-margin-bottom-20" src="assets/img/blog/17.jpg" alt=""></a>
                            </div> 
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
                    ...
                    <div class="list-product-description product-description-brd margin-bottom-30">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.jsp"><img class="img-responsive sm-margin-bottom-20" src="assets/img/blog/21.jpg" alt=""></a>
                            </div> 
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
                    ...
                    <div class="list-product-description product-description-brd margin-bottom-30">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.jsp"><img class="img-responsive sm-margin-bottom-20" src="assets/img/blog/22.jpg" alt=""></a>
                            </div> 
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
                    ...
                    <div class="list-product-description product-description-brd">
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="shop-ui-inner.jsp"><img class="img-responsive sm-margin-bottom-20" src="assets/img/blog/23.jpg" alt=""></a>
                            </div> 
                            <div class="col-sm-8 product-description">
                                <div class="overflow-h margin-bottom-5">
                                    <ul class="list-inline overflow-h">
