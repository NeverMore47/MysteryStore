					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul class="list-inline right-topbar pull-right">
								<c:if test="${sessionScope.custInfo != null}">
									<li>Hello,</li>
									<li><a href="#"><font color="red">${custInfo.custName}</font></a></li>
									<li><a href="shop-ui-wishlist.jsp">Wishlist (<span id="wishNum">${wishNum}</span>)</a></li>
									<li><i class="search fa fa-search search-button"></i></li>
								</c:if>
								<c:if test="${sessionScope.custInfo == null}">
									<li><a href="#">Account</a></li>
									<li><a href="shop-ui-wishlist.jsp">Wishlist (0)</a></li>
									<li><a href="shop-ui-login.jsp">Login</a> | <a
										href="shop-ui-register.jsp">Register</a></li>
									<li><i class="search fa fa-search search-button"></i></li>
								</c:if>
							</ul>
						</div>
			...
			<div class="navbar navbar-default mega-menu" role="navigation">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="http://localhost:8080/MysteryStore1.0/user/show_queryFeat.action"> <img
					...
					<div class="collapse navbar-collapse navbar-responsive-collapse">
						...
						<ul class="list-inline shop-badge badge-lists badge-icons pull-right">
							<li id="showCart"><a href="/MysteryStore1.0/user/queryCart.action"><i class="fa fa-shopping-cart"></i></a> <span
								class="badge badge-sea rounded-x" id="cartNum">${cartNum}</span>
								<ul class="list-unstyled badge-open mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" style="overflow: visible;" 
									data-mcs-theme="minimal-dark" id="showUl">
									
									<!-- <li><img src="assets/img/thumb/05.jpg" alt="">
										<button type="button" class="close">×</button>
										<div class="overflow-h">
											<span>Black Glasses</span> <small>1 x $400.00</small>
										</div>
									</li>
									<li><img src="assets/img/thumb/02.jpg" alt="">
										<button type="button" class="close">×</button>
										<div class="overflow-h">
											<span>Black Glasses</span> <small>1 x $400.00</small>
										</div></li>
									<li><img src="assets/img/thumb/03.jpg" alt="">
										<button type="button" class="close">×</button>
										<div class="overflow-h">
											<span>Black Glasses</span> <small>1 x $400.00</small>
										</div></li> -->
									<!-- <li class="subtotal">
										<div class="overflow-h margin-bottom-10">
											<span>Subtotal</span> <span class="pull-right subtotal-cost">$1200.00</span>
										</div>
										<div class="row">
											<div class="col-xs-6">
												<a href="/MysteryStore1.0/user/product_queryOne.action"
													class="btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block">View
													Cart</a>
											</div>
											<div class="col-xs-6">
												<a href="shop-ui-add-to-cart.jsp"
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active"><a href="javascript:void(0);"
								...
								<ul class="dropdown-menu">
									<li class="active"><a href="http://localhost:8080/MysteryStore1.0/user/show_queryFeat.action">Shop UI</a></li>
									<li><a href="/MysteryStore1.0/user/filterGrid_queryFilter.action">Filter Grid Page</a></li>
									<li><a href="shop-ui-filter-list.jsp">Filter List Page</a></li>
									<li><a href="shop-ui-add-to-cart.jsp">Checkout</a></li>
							...
							<li class="dropdown mega-menu-fullwidth"><a
								...
								data-hover="dropdown" data-toggle="dropdown"> Gifts </a>
								<ul class="dropdown-menu">
									<li>
												...
												<div class="row">
													<div
														...
														<p>Proin pulvinar libero quis auctor pharet ra. Aenean
															...
															Nulla dolor nisl, molestie nec aliquam vitae, gravida
															sodals dolor...</p>
														<button type="button" class="btn-u btn-u-dark">Read
															More</button>
													</div>
							...
							<li class="dropdown mega-menu-fullwidth"><a
								href="javascript:void(0);" class="dropdown-toggle"
								data-hover="dropdown" data-toggle="dropdown"> Books </a>
								<ul class="dropdown-menu">
									<li>
										<div class="mega-menu-content">
											<div class="container">
							...
							<li class="dropdown"><a href="javascript:void(0);"
								class="dropdown-toggle" data-hover="dropdown"
								data-toggle="dropdown" data-delay="1000"> Clothes </a>
								<ul class="dropdown-menu">
									<li><a href="#">Jeans</a></li>
									<li><a href="#">T-shirts</a></li>
									<li><a href="#">Shorts</a></li>
							...
							<!-- Main Demo -->
							<li><a href="../http://localhost:8080/MysteryStore1.0/user/show_queryFeat.action">Main Demo</a></li>
							<!-- Main Demo -->
						</ul>
						<!-- End Nav Menu -->
					</div>
			...
			<div class="tp-banner">
				<ul>
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="assets/img/1.jpg" alt="darkblurbg"
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="assets/img/5.jpg" alt="darkblurbg"
						data-bgfit="cover" data-bgposition="left top"
						data-bgrepeat="no-repeat">
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="assets/img/3.jpg" alt="darkblurbg"
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="assets/img/2.jpg" alt="darkblurbg"
						data-bgfit="cover" data-bgposition="left top"
						data-bgrepeat="no-repeat">
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="assets/img/4.jpg" alt="darkblurbg"
						data-bgfit="cover" data-bgposition="right top"
						data-bgrepeat="no-repeat">
		...
		<div class="container content-md">
						...
						<a class="illustration-v1 illustration-img2" href="#"> <span
							class="illustration-bg"> <span
								class="illustration-ads ad-details-v2"> <span
									class="item-time">Spring 2017</span> <span class="item-name">Lacoste</span>
							</span>
						</span>
						</a>
					</div>
			...
			<div class="illustration-v2 margin-bottom-60">
				...
				<ul class="list-inline owl-slider">
					<c:forEach items="${listFeat}" var="f">
						<li class="item">
							<div class="product-img">
								<a href="/MysteryStore1.0/user/product_queryOne.action?proId=${f.proId}"><img
									class="full-width img-responsive"
									src="<%= basePath%>${f.proImgSrc}" alt=""></a> <a style="cursor: pointer;" class="add-to-cart" ><i
								...
								<div class="overflow-h margin-bottom-5">
									<div class="pull-left">
										<h4 class="title-price">
											<a href="/MysteryStore1.0/user/product_queryOne.action?proId=${f.proId}">${f.proName}</a>
										</h4>
										<span class="gender text-uppercase">${f.proGender}</span> <span
											class="gender">${f.type.typeName}-${f.category.cateName}</span>
									</div>
									<div class="product-price">
										<span class="title-price">¥${f.proPrice}</span>
										<input type="hidden" value="${f.proId}" class="proId">
									</div>
								</div>
								
								<ul class="list-inline product-ratings" id="star">
									<c:forEach begin="1" end="5" varStatus="status">
										<c:if test="${status.index<=f.review.reRating }">
									...
									<li class="like-icon">
										<a data-original-title="Add to wishlist" data-toggle="tooltip" data-placement="left" class="tooltips" href="javascript:void(0)">
					...
					<!-- <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.jsp"><img class="full-width img-responsive" src="assets/img/blog/26.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.jsp">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
                        <div class="overflow-h margin-bottom-5">
                            <div class="pull-left">
                                <h4 class="title-price"><a href="shop-ui-inner.jsp">Double-breasted</a></h4>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.jsp"><img class="full-width img-responsive" src="assets/img/blog/11.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.jsp">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.jsp"><img class="full-width img-responsive" src="assets/img/blog/12.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.jsp">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.jsp"><img class="full-width img-responsive" src="assets/img/blog/10.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.jsp">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div> 
                    <div class="product-description product-description-brd">
						...
						<a class="illustration-v3 illustration-img1" href="#"> <span
							class="illustration-bg"> <span class="illustration-ads">
									<span class="illustration-v3-category"> <span
										...
										class="product-amount">${menNum} Items</span>
								</span>
							</span>
						</span>
						</a>
						...
						<a class="illustration-v3 illustration-img2" href="#"> <span
							class="illustration-bg"> <span class="illustration-ads">
									<span class="illustration-v3-category"> <span
										...
										class="product-amount">${womenNum} Items</span>
								</span>
							</span>
						</span>
						</a>
						...
						<a class="illustration-v3 illustration-img3" href="#"> <span
							class="illustration-bg"> <span class="illustration-ads">
									<span class="illustration-v3-category"> <span
										...
										class="product-amount">${childNum} Items</span>
								</span>
							</span>
						</span>
						</a>
			...
			<div class="row illustration-v2">
				<c:forEach items="${productNewList}" var="pn">
					<div class="col-md-3 col-sm-6 md-margin-bottom-30">
						<div class="product-img">
							<a href="/MysteryStore1.0/user/product_queryOne.action?proId=${pn.proId}"><img
								class="full-width img-responsive" src="<%=basePath %>${pn.proImgSrc}"
								alt=""></a><a class="add-to-cart" href="javascript:void(0)"><i
								class="fa fa-shopping-cart"></i>Add to cart</a>
						</div>
						<div class="product-description product-description-brd">
							<div class="overflow-h margin-bottom-5">
								<div class="pull-left">
									<h4 class="title-price">
										<a href="/MysteryStore1.0/user/product_queryOne.action?proId=${pn.proId}">${pn.proName}</a>
										<input type="hidden" class="proId" value="${pn.proId}">
									</h4>
									<span class="gender text-uppercase">${pn.proGender}</span> <span
										class="gender">${pn.category.cateName} - ${pn.type.typeName}</span>
								</div>
								<div class="product-price">
									<span class="title-price">¥${pn.proPrice}</span>
								</div>
							</div>
							<ul class="list-inline product-ratings">
								<c:forEach begin="1" end="5" varStatus="status">
									<c:if test="${status.index <= pn.review.reRating }">
										<li><i class="rating-selected fa fa-star"></i></li>
									</c:if>
									<c:if test="${status.index > pn.review.reRating }">
									<li><i class="rating fa fa-star"></i></li>
								...
								<li class="like-icon"><a
									...
									data-placement="left" class="tooltips" href="javascript:void(0)"><i
				...
				<!-- <div class="col-md-3 col-sm-6 md-margin-bottom-30">
					<div class="product-img">
						<a href="shop-ui-inner.jsp"><img
							class="full-width img-responsive" src="assets/img/blog/09.jpg"
							alt=""></a> <a class="product-review" href="shop-ui-inner.jsp">Quick
					...
					<div class="product-description product-description-brd">
						<div class="overflow-h margin-bottom-5">
							<div class="pull-left">
								<h4 class="title-price">
									<a href="shop-ui-inner.jsp">Double-breasted</a>
								</h4>
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-30">
					<div class="product-img">
						<a href="shop-ui-inner.jsp"><img
							class="full-width img-responsive" src="assets/img/blog/10.jpg"
							alt=""></a> <a class="product-review" href="shop-ui-inner.jsp">Quick
							review</a> <a class="add-to-cart" href="#"><i
							class="fa fa-shopping-cart"></i>Add to cart</a>
						<div class="shop-rgba-red rgba-banner">Out of stock</div>
					...
					<div class="product-description product-description-brd">
						<div class="overflow-h margin-bottom-5">
							<div class="pull-left">
								...
								<span class="gender text-uppercase">Women</span> <span
									class="gender">Suits - Blazers</span>
							</div>
							<div class="product-price">
								<span class="title-price">$95.00</span>
				...
				<div class="col-md-3 col-sm-6 md-margin-bottom-30">
					<div class="product-img">
						<a href="shop-ui-inner.jsp"><img
							class="full-width img-responsive" src="assets/img/blog/11.jpg"
							alt=""></a> <a class="product-review" href="shop-ui-inner.jsp">Quick
							review</a> <a class="add-to-cart" href="#"><i
							class="fa fa-shopping-cart"></i>Add to cart</a>
						<div class="shop-rgba-dark-green rgba-banner">New</div>
			...
			<div class="row illustration-v4 margin-bottom-40">
				<div class="col-md-4">
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/08.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
									href="shop-ui-inner.jsp">Derby Shoe</a>
							</h4>
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/09.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/03.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
				...
				<div class="col-md-4">
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/02.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/10.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/06.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
				...
				<div class="col-md-4 padding">
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/07.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/04.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
					...
					<div class="thumb-product">
						<img class="thumb-product-img" src="assets/img/thumb/05.jpg"
							alt="">
						<div class="thumb-product-in">
							<h4>
								<a href="shop-ui-inner.jsp">Yuketen</a> – <a
		...
		<div class="container content">
			...
			<ul class="list-inline owl-slider-v2">
				<li class="item first-child"><img
					src="assets/img/clients/07.png" alt=""></li>
				<li class="item"><img src="assets/img/clients/08.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/10.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/11.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/09.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/12.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/07.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/08.png" alt="">
				</li>
				<li class="item"><img src="assets/img/clients/09.png" alt="">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 md-margin-bottom-40">
							<a href="http://localhost:8080/MysteryStore1.0/user/show_queryFeat.action"><img class="footer-logo"
...
<script type="text/javascript">
	...
	$(".add-to-cart").click(function () {
		...
		var id = ids.eq(index).val();
		$.ajax({
		    url:"/MysteryStore1.0/customer/checkIsLogin.action",
			dataType:"json",
			success:function(result){
				if(result.isLogin){
					$.ajax({
						url:"/MysteryStore1.0/cart/addToCart_addToCart.action",
						data:{proId : id},
						success:function(result) {
							if(result.isSuccess) {
								alert("添加购物车成功");
								$.ajax({
									url:"/MysteryStore1.0/user/queryCart.action",
									dataType:"json",
									success:function(result) {
										$("#cartNum").text(result);
									}
					...
					alert("请先登录");
					window.location.href="/MysteryStore1.0/user/shop-ui-login.jsp";
				}
			}
		});
	});
	...
	as.click(function () {
		...
		$.ajax({
			...
			success:function(result){
				if(result.isLogin){
					$.ajax({
						url:"/MysteryStore1.0/wishList/addToWishlist_addToWishList.action",
						data:{proId : id},
						success:function(result) {
							if(result.isExist) {
								if(result.isSuccess) {
									alert("添加到心愿单成功");
									var num = parseInt($("#wishNum").text());
									$("#wishNum").text(num + 1);
								} else {
									alert("添加到心愿单失败");
								}
...
<script type="text/javascript">
	$("#showCart").mouseover(function() {
		$.ajax({
			url:"/MysteryStore1.0/cart/addToCart_showCart.action",
			success:function(result) {
				var list = result.listcart;
				var text = "<div id='mCSB_1' class='mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside' tabindex='0'><div id='mCSB_1_container' class='mCSB_container mCS_y_hidden mCS_no_scrollbar_y' style='position:relative; top:0; left:0;' dir='ltr'>";
				var proPrice = 0;
				var proDiscount = 0;
				var quantity = 0;
				var subtotal = 0;
				for(var i = 0;i < list.length;i++) {
					var proName = list[i][0];
					proPrice = list[i][1];
					proDiscount = list[i][2];
					quantity = list[i][3];
					var proImgSrc = list[i][4];
					var path="<%=basePath%>";
					text += "<li><img class='mCS_img_loaded' style='height:100px;width:100px;' src= '"+path+ proImgSrc +"'><button type='button' class='close'>×</button><div class='overflow-h'><span>"+proName+"</span> <small>"+quantity+" x ¥" + proPrice + "</small></div></li>";
					subtotal += proPrice * (proDiscount/10) * quantity;
				}
				text += "<li class='subtotal'><div class='overflow-h margin-bottom-10'><span>Subtotal</span> <span class='pull-right subtotal-cost'>¥"+subtotal+"</span></div><div class='row'><div class='col-xs-6'><a href='/MysteryStore1.0/user/product_queryOne.action' class='btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block'>ViewCart</a></div><div class='col-xs-6'><a href='shop-ui-add-to-cart.jsp'class='btn-u btn-u-sea-shop btn-block'>Checkout</a></div></div></li></div></div><div id='mCSB_1_scrollbar_vertical' class='mCSB_scrollTools mCSB_1_scrollbar mCS-minimal-dark mCSB_scrollTools_vertical' style='display: none;'> <div class='mCSB_draggerContainer'><div id='mCSB_1_dragger_vertical' class='mCSB_dragger' style='position: absolute; min-height: 50px; top: 0px; display: block; height: 298px; max-height: 364px;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' style='line-height: 50px;'></div></div><div class='mCSB_draggerRail'></div></div></div>";
				$("#showUl").html(text);
			}
		});
	});
