                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="shop-ui-add-to-cart.jsp">Checkout</a></li>
                    ...
                    <section>
                        <div class="table-responsive">
                            <table class="table table-striped" id="tab">
                                ...
                                <tbody>
                                	<c:forEach items="${listCartDetails}" var="cart">
                                    <tr>
                                        <td class="product-in-table">
                                            <img class="img-responsive" src="<%=basePath %>${cart.product.proImgSrc}" alt="">
                                            <div class="product-it-in">
                                                <h3>${cart.product.proName}</h3>
                                                <span>Sed aliquam tincidunt tempus</span>
                                            </div>    
                                        </td>
                                        <td>¥<span class="price">${cart.product.proPrice * (cart.product.proDiscount / 10)}</span></td>
                                        <td>
                                            <button type='button' class="quantity-button min" name='subtract' value='-'>-</button>
                                            <input type='text' class="quantity-field qty" name='qty1' value="${cart.id.quantity}" id='qty1'/>
                                            <button type='button' class="quantity-button add" name='add' value='+'>+</button>
                                        </td>
                                        		
                                        <td class="shop-red"><span class="littlePrice">${cart.product.proPrice * (cart.product.proDiscount / 10) * cart.id.quantity}</span></td>
                                        <td>
                                    ...
                                    <script type="text/javascript">
                                    	$(".min").click(function() {
                                    		var t = $(this).parent().find('input[class*=qty]');
                                    		t.val(parseInt(t.val())-1);
                                    		if(parseInt(t.val())<0){ 
												t.val(0); 
											} 
											var t1 = $(this).parent().parent();
											var price = parseFloat(t1.find('span[class*=price]').text());
											var qty = parseInt(t.val());
											var littlePrice = qty * price; 
											t1.find('span[class*=littlePrice]').text(littlePrice);
